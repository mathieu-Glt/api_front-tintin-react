...
export default function Register() {
  ...
  return (
    <div>
      <h1 className="bg-white text-dark">REGISTER</h1>

      <form className="form">
        <label htmlFor="firstname" style={{ color: "black" }}>
          <strong>Entry your firstName :</strong>
        </label>
        <input
          value={firstname}
        ...
        <label htmlFor="lastname" style={{ color: "black" }}>
          <strong>Entry your lastName :</strong>
        </label>
        <input
          value={lastname}
        ...
        <label htmlFor="email" style={{ color: "black" }}>
          <strong>Entry your email :</strong>
        </label>
        <input
          type="email"
          value={email}
        ...
        <label htmlFor="password" style={{ color: "black" }}>
          <strong>Entry your password :</strong>
        </label>
        <input
          type="password"
          value={password}
