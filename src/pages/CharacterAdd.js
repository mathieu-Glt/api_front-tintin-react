...
export default function CharacterAdd() {
  ...
  function handleSubmitForm(e) {
    ...
    if (userData.role) {
      ...
      toast.success(
        "Vous devez créer un compte pour enregistrer le film en favori",
        { type: "info", theme: "colored", autoClose: 5000 },
      );
    }
    ...
    async function postAddCharacter() {
      ...
      try {
        const request = await axios
          .post(requests.fecthAddCharacter, body, {
            headers: {
  ...
  return (
    <div>
      ...
      <form className="form">
        <label htmlFor="namePerso" style={{ color: "black" }}>
          <strong>Nom personnage :</strong>
        </label>
        <input
          type="text"
          value={nom}
        ...
        <label htmlFor="firstnamePerso" style={{ color: "black" }}>
          <strong>Prenom personnage :</strong>
        </label>
        <input
          type="text"
          value={prenom}
        ...
        <label htmlFor="picturePerso" style={{ color: "black" }}>
          <strong>Picture personnage :</strong>
        </label>
        <input
          type="text"
          value={picture}
        ...
        <label htmlFor="profPerso" style={{ color: "black" }}>
          <strong>Profession personnage :</strong>
        </label>
        <input
          type="text"
          value={profession}
        ...
        <label htmlFor="desPerso" style={{ color: "black" }}>
          <strong>Description personnage :</strong>
        </label>
        <input
          type="text"
          value={personnage}
        ...
        <label htmlFor="suiteDesPerso" style={{ color: "black" }}>
          <strong>Description personnage suite :</strong>
        </label>
        <input
          type="text"
          value={personnageSuite}
          id="suiteDesPerso"
          name="suiteDesPerso"
          onChange={handleChangePersonnageSuite}
          required
        />

        <label htmlFor="slugPerso" style={{ color: "black" }}>
          <strong>Slug personnage :</strong>
        </label>
        <input
          type="text"
          value={slug}
        ...
        <button className="submit-form" onClick={handleSubmitForm}>
          Submit
        </button>
      </form>
    </div>
