// import requests, { configApi } from '../../configApi/Request';
...
/***
 * composant abandonné provisoirement !!!!!
 */
...
//                     <div  key={index} className="movie_container p-4 card text-bg-dark mb-3 d-flex flex-column m-4 w-25 justify-content-center">
//                         <div className="image ">
//                             <div className="movie">
//                                 <img className="image_database" alt="image_perso" src={process.env.PUBLIC_URL + '/seriePerso/' + characterDatabase.picture} />
//                             </div>
//                         </div>
