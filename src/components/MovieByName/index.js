    ...
    <div>
      ...
      <section className="card_movie d-flex flex-row flex-wrap justify-content-center p-4 pt-4">
        {movieDatabase.map((movieDatabase, index) => (
          <div
            className="movie_container p-4 card text-bg-dark mb-3 d-flex flex-column m-4 w-25 justify-content-center"
            key={index}
          >
            ...
            <div className="image_movie ">
              <div className="movie">
                <img
                  ...
                  src={
                    process.env.PUBLIC_URL + "/tintin/" + movieDatabase.picture
                  }
                />
              </div>
            ...
            <div
              type="button"
              className="movies__buttons p-2 d-flex flex-row justify-content-around "
            >
              <Link to={`/movie/${index}`}>
