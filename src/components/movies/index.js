...
// composant d'affichage de tous les films mais abandonné
function Movies() {
                    ...
                    <div className="movie_container p-4 card text-bg-dark mb-3 d-flex flex-column m-4 w-25 justify-content-center" key={index}>
                        <div className="image ">
                            <div className="movie" key={index}>
                                <img className="image_database" alt="poqter_film_tintin" src={process.env.PUBLIC_URL + 'tintin/' + movieDatabase.picture} />
                            </div>
                        </div>
