  ...
  return (
    <div>
      ...
      <div>
        ...
        >
          <img
            className="image_dupont1"
            alt="image_dupont"
            src={process.env.PUBLIC_URL + "/assets/dupond.jpg"}
          />
          <p>
            {" "}
            C'était bien tenté ! Tu dois creer un compte pour enregistrer tes
            favoris !!
          </p>
        </div>
        ...
        >
          <img
            className="image_dupont2"
            alt="image_duppont"
            src={process.env.PUBLIC_URL + "/assets/dupond.jpg"}
          />
          <p>
            {" "}
            Je dirais même plus ! Tu dois creer un compte pour enregistrer tes
            favoris !!!
          </p>
        </div>
      </div>
      ...
      <section className="card_movie_section_favories ">
        ...
        {movieFavorite.map((movie, index) => (
          <div className="movie_container_favories" key={index}>
            ...
            <a className="link-favourite" href="#">
              <FavoriteIcon
            ...
            <p className="movies__synopsis_favories">{movie.synopsis}</p>
            <div className="movies__buttons_favoris_lecture ">
              ...
              >
                <PlayCircleIcon />
                <HashLink className="text-dark" smooth to="#movie-tintin">
                  Lecture
                </HashLink>
              </button>
            </div>
            <div type="button" className="movies__buttons_favoris">
              ...
              <Link to={`/movies/${movie.slug}`}>
                <button className="card_button_acceuil_details">Plus</button>
              </Link>
