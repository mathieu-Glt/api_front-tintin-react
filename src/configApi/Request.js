...
const requests = {
  ...
  fetchAllTintinDatabase: `${api_url}/api/tintin/`,
  // fetchAllTintinDatabaseNotUser: `${api_url}/api/unknowuser/movies`, // server api-bact-tintin
  fetchAllTintinDatabaseNotUser: `${api_url}/api/tintin/unknowuser/movies`,
  ...
  fetchAllCharactersDatabase: `${api_url}/api/character/`,
  ...
  fetchMovieRate: `${api_url}/api/tintin/movie/rate`,
  // pas terminer fetchNoteMovie, // server api-bact-tintin
  fetchNoteMovie: `${api_url}/api/tintin/movie/rate`,
  ...
  fetchEditMovie: `${api_url}/api/tintin/tintin/update/`,
  ...
  fecthAddCharacter: `${api_url}/api/character/save`,
  // fetchDeleteMovie: `${api_url}/api/v1/movie/delete/`, // server api-bact-tintin
  fetchDeleteMovie: `${api_url}/api/tintin/delete/`,
  ...
  fetchDeleteCharacter: `${api_url}/api/character/delete/`,
  // fetchUploadPicture: `${api_url}/api/v1/upload/pict`, // server api-bact-tintin
  fetchUploadPicture: `${api_url}/api/tintin/upload/pict`,
  // fetchRandomMovie: `${api_url}/api/v1/random_movie`, // server api-bact-tintin
  fetchRandomMovie: `${api_url}/api/tintin/v3/random_movie`,
